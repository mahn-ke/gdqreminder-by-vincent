# Backend for [GDQReminder App](https://github.com/ViMaSter/gdqreminder-mobile/) [![codecov](https://codecov.io/gh/mahn-ke/gdqreminder-by-vincent/branch/main/graph/badge.svg?token=0CRSIRXAS1)](https://codecov.io/gh/mahn-ke/gdqreminder-by-vincent)
...
6. Run 
   ```ps
     docker run --name gdqreminder-by-vincent -d --restart unless-stopped -v $(pwd):/firebase --env-file ./.env ghcr.io/mahn-ke/gdqreminder-by-vincent:main --refreshIntervalInMS=60000
   ```
